  ...
  const onSubmit = async (values: InsuranceFormValues) => {
    ...
    try {
      ...
      if (id && id !== 'new') {
        ...
        if (!result.error) {
          toast({ title: "Sucesso", description: "Convênio atualizado com sucesso" });
        }
      } else {
        result = await supabase
          .from('insurance_companies')
        ...
        if (!result.error) {
          toast({ title: "Sucesso", description: "Convênio criado com sucesso" });
          if (result.data?.id) {
      ...
      <div className="space-y-6">
        ...
        {!canSubmit && (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              {!user ? 'Você precisa estar logado para gerenciar convênios.' : 
               'Selecione uma clínica para gerenciar convênios. Use o seletor de clínicas no cabeçalho.'}
            </AlertDescription>
          </Alert>
        )}
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                      <div className="flex-1 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <FormField control={form.control} name="ansRegistry" render={({ field }) => (
                            <FormItem>
