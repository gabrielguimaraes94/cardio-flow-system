...
import { User, Users, Heart, FileText, Calendar, Settings, LogOut, Menu, UserPlus, FileUser, BarChart, Building2, FileContract } from 'lucide-react';
import { 
  ...
  const menuItems = [
    ...
    { 
      ...
      submenu: [
        ...
        { title: "Contratos", url: "/insurance", icon: FileContract, 
          disabled: true, 
